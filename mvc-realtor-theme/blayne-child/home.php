...
if ( $hero_image ) {
    ...
    $hero_style = ' style="background-image: url(' . esc_url( $hero_url ) . ');"';
}
?>
<section class="blog-hero"<?php echo $hero_style; ?>>
    <div class="blog-hero__overlay"></div>  ← add this
    <div class="blog-hero__inner">
        <h1 class="blog-hero__title">News &amp; Guides</h1>
        <p class="blog-hero__sub">Real estate insights...</p>
    </div>
</section>
