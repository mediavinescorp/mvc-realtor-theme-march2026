...
<li class="site-nav__item">
    <a href="<?php echo esc_url( get_post_type_archive_link( 'service' ) ); ?>"
       class="site-nav__link <?php echo is_post_type_archive( 'service' ) ? 'site-nav__link--active' : ''; ?>">Services</a>
</li>
...
<li class="site-nav__item">
    <a href="<?php echo esc_url( home_url( '/search/' ) ); ?>" 
       class="site-nav__link <?php echo is_page( 'search' ) ? 'site-nav__link--active' : ''; ?>">Search Homes</a>
</li>
